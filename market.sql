...
ALTER USER 'tu_usuario'@'tu_host' IDENTIFIED WITH 'mysql_native_password' BY 'tu_contraseña';
...
--
ALTER TABLE `pedidos_estados`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=179937; sdgfsdgsdg
